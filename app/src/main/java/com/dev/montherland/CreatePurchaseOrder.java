...
import com.dev.montherland.adapter.ExpandableListView;
       ...
       try {
        ...
        customerList.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    customerId = customerLIst.get(position).toString();
                ...
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            garmentList.add(response_model.get(0).getName());
                            garmentList.add(response_model.get(1).getName());
                            garmentList.add(response_model.get(2).getName());
                            garmentList.add(response_model.get(3).getName());

                            /*Log.v("modelsize", response_model.size()+"");
                            for (int i=0;i<=response_model.size();i++){
                                garmentList.add(response_model.get(i).getName());
                            }*/
