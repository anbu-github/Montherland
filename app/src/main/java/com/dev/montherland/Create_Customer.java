...
//        });
                ...
                builder.setCancelable(false)
                        ...
                        .setNegativeButton("ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(thisActivity, CustomerDetails.class);
                                thisActivity.finish();
    ...
    void updatedisplay(String id){
        ...
        if(id != null) {
            ...
            if(id.equals("Success")) {
                ...
                builder.setCancelable(false)
                        .setTitle("Success")
                        .setMessage("Customer has saved successfully")
                        .setNegativeButton("ok", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
    ...
    public void onBack(){
        if (menuTitle.contains("Edit_Contact")){
            Intent in=new Intent(thisActivity,Customer_contact_details.class);
        ...
        else if (menuTitle.contains("Edit_Customer")){
            Intent in=new Intent(thisActivity,CustomerDetails.class);
            overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
