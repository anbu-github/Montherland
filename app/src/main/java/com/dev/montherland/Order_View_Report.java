...
public class Order_View_Report extends Fragment implements ActionBar.TabListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.order_view, container, false);
        ...
        public Fragment getItem(int i) {
            switch (i) {
                case 0: {
                    ...
                    Fragment fragment = new MonthlyReportFragment();
                ...
                case 1: {
                    ...
                    Fragment fragment2 = new CustomerReportFragment();
