...
import com.dev.montherland.customers.adapter.AddressCreateAdapter;
import com.dev.montherland.customers.adapter.AddressSelectAdapter;
import com.dev.montherland.customers.adapter.CustomerAddressesListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ig.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SelectAddress.this, com.dev.montherland.customers.CreateAddress.class);
                if (menuTitle.contains("customer_address")) {
