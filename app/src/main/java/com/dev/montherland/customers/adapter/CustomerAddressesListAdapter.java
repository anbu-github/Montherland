...
public class CustomerAddressesListAdapter extends RecyclerView.Adapter<CustomerAddressesListAdapter.MyViewHolder> {
    ...
    public CustomerAddressesListAdapter(List<Create_Address_Model> persons,Context context,String intent_from) {
        this.persons = persons;
        this.mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (intent_from.equals("")){
             v = LayoutInflater.from(parent.getContext()).inflate(R.layout.select_address_adpter, parent, false);
        }
        else {
                                        ...
                                        .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                if (StaticVariables.mode.equals("customor_address")) {
                                                    ...
                                                    Intent intent = new Intent(mContext, com.dev.montherland.customers.Customer_contact_details.class);
                                                    mContext.startActivity(intent);
                                                    ((Activity) mContext).finish();
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, com.dev.montherland.customers.CustomerEditAddress.class);
                cbPos = position;
                try {
        ...
        /*if (intent_from.equals("")){
            ...
            if(persons.get(position).getStatus().equals("selected")){
                ...
                StaticVariables.addressIdList.remove(position);
                StaticVariables.addressIdList.add(position, "true");
            }
            else {
         ...
         Log.v("listdetails",StaticVariables.addressIdList.toString());
*/       // CreateOrderAdapter.ViewHolder holder;
